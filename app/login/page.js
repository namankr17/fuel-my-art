...
const page = () => {
    ...
    useEffect(() => {
        document.title = 'Login - Fuel My Art'
    }, [])
  ...
  if (session) return null
    return (
        <div className='text-white py-20 flex flex-col items-center gap-10 px-5'>
            <h1 className='font-bold text-3xl text-center'>Login/Signup to get started</h1>
